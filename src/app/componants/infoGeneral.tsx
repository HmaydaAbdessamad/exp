...
const Header = () => {
    ...
    return (
        <>
            <div className="hidden md:block  flex  flex-col gap-5 py-5   ">
                ...
                <div
                    className=" flex flex-col items-start mx-3 md:flex-row  md:justify-around md:items-center md:mx-5 ">
                ...
                <div className=" flex flex-col  items-start  gap-4 mx-5 ">
                    ...
                    <textarea id="Observation" name="Observation"
                              className="w-full md:w-1/2 h-auto border border-3 border-black">
            ...
            <div className="block md:hidden flex flex-col gap-3">
                ...
                <div className=" flex flex-row justify-start items-center mx-2  md:mx-5 ">
                    <h1 className="text-xl font-bold">Date: {formattedDate}</h1>
                </div>
                ...
                <div className=" flex flex-col  justify-between items-center mx-2  md:mx-5 ">
